                ...
                <div className="tiles-item-inner">
                  ...
                  <div className="features-tiles-item-content">
                    ...
                    <p className="m-0 text-sm">
                      Instantly understand how your base feels about pressing issues. Make informed decisions on the campaign trail and in office. 
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="tiles-item reveal-from-bottom" data-reveal-container=".tiles-wrap" data-reveal-delay="100">
                <div className="tiles-item-inner">
                  ...
                  <div className="features-tiles-item-content">
                    ...
                    <p className="m-0 text-sm">
                      Analyse sentiment trends in social media and product reviews. Optimize your marketing strategy for your targeted audience.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="tiles-item-inner">
                  ...
                  <div className="features-tiles-item-content">
                    ...
                    <p className="m-0 text-sm">
                      ...
                      Use data-driven techniques to optimize for virality and to build a strong base of committed followers.
                  </div>
                </div>
              </div>
              {/*
